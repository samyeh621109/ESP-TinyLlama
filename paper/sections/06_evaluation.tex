...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{figures/project_summary_viz.png}
    \caption{Ternary-Mamba Analysis: (Left) Weight distribution demonstrating the 1.58-bit (ternary) property of the quantized model; (Right) Validation loss convergence comparison between the FP32 baseline and the 1.58-bit Ternary-Mamba model.}
    \label{fig:ternary_analysis}
\end{figure}
